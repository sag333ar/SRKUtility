...
#import "SRKImageCropView.h"

@interface SRKImageCropViewController ()

@property (nonatomic, strong) SRKImageCropView *imageCropView;
...
@implementation SRKImageCropViewController
...
- (void)_setupCropView{
    ...
    self.imageCropView = [[SRKImageCropView alloc] initWithFrame:self.view.bounds];
...
- (void)_setupCancelButton{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
        ...
        [self.cancelButton setBackgroundImage:[[UIImage imageNamed:@"SRKCameraSheetButton.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateNormal];
        [self.cancelButton setBackgroundImage:[[UIImage imageNamed:@"SRKCameraSheetButtonPressed.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateHighlighted];
...
- (void)_setupUseButton{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
        ...
        [self.useButton setBackgroundImage:[[UIImage imageNamed:@"SRKCameraSheetDoneButton.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateNormal];
        [self.useButton setBackgroundImage:[[UIImage imageNamed:@"SRKCameraSheetDoneButtonPressed.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateHighlighted];
...
- (void)_setupToolbar{
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        ...
        if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
            ...
            info.text = NSLocalizedString(@"Please move and scale", @"");
        }
